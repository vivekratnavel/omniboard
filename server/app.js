...
//our headers to allow CORS with middleware like so:
  ...
  restify.serve(router, RunsModel(databaseConn));
  restify.serve(router, MetricsModel(databaseConn));
  restify.serve(router, OmniboardColumnsModel(databaseConn));
  restify.serve(router, OmniboardConfigColumnsModel(databaseConn));
